...
import time
import urllib3
from ..models import TaskmanageScanner
...
def get_scannerinfo(scanner_id):
    scanner = TaskmanageScanner.query.filter_by(id=scanner_id).first()

    url = scanner.Scannerurl
    Access_Key = scanner.Scannerapikey
    Secret_Key = scanner.Scannerapisec
